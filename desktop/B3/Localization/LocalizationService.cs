...
public class LocalizationService : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, (string Zh, string En)> Strings = new()
    {
        ...
        ["SectionEditor"] = ("程式編輯器", "Code Editor"),
        ["EditorHeader"] = ("Code Space 語法上色", "Code Space Syntax Highlighting"),
        ["SyntaxHighlightTitle"] = ("啟用語法上色", "Enable syntax highlighting"),
        ["SyntaxHighlightDesc"] = ("依據選擇的程式語言為關鍵字等元素上色", "Color keywords and other tokens based on the selected language"),
        ["SyntaxColorsTitle"] = ("配色", "Colors"),
        ["SyntaxColorsDesc"] = ("點選色塊調整各類語法元素的顏色，變更會自動儲存", "Click a swatch to adjust each token color; changes are saved automatically"),
        ["SyntaxPreview"] = ("預覽", "Preview"),
        ["SyntaxResetColors"] = ("還原預設配色", "Reset colors"),
        ["SyntaxPlainText"] = ("一般文字", "Plain text"),
        ["SyntaxKeyword"] = ("關鍵字", "Keyword"),
        ["SyntaxType"] = ("型別 / 內建名稱", "Type / built-in"),
        ["SyntaxFunction"] = ("函式呼叫", "Function call"),
        ["SyntaxString"] = ("字串 / 字元", "String / char"),
        ["SyntaxNumber"] = ("數字", "Number"),
        ["SyntaxComment"] = ("註解", "Comment"),
        ["SyntaxPreprocessor"] = ("前置指令 / 裝飾器", "Preprocessor / decorator"),
        ...
        ["JavaPath"] = ("Java 路徑", "Java Path"),
        ["RuntimeEnvironmentDesc"] = ("自動配置會先偵測已安裝的環境，找不到時透過套件管理員 (Windows: winget) 安裝並填入路徑", "Auto setup detects installed runtimes first, then installs via the package manager (Windows: winget) and fills in the path"),
        ["AutoInstall"] = ("自動安裝", "Auto Install"),
        ["AutoConfigureAll"] = ("全部自動配置", "Auto Setup All"),
        ["RtDetecting"] = ("正在偵測已安裝的環境...", "Detecting installed runtime..."),
        ["RtFoundFmt"] = ("✔ 已找到：{0}", "✔ Found: {0}"),
        ["RtInstalledFmt"] = ("✔ 安裝完成：{0}", "✔ Installed: {0}"),
        ["RtInstallingFmt"] = ("正在安裝 (可能需要數分鐘，請留意系統權限提示)：{0} {1}", "Installing (may take a few minutes, watch for permission prompts): {0} {1}"),
        ["RtVerifying"] = ("安裝程序結束，正在確認...", "Installer finished, verifying..."),
        ["RtInstallFailedFmt"] = ("✘ 安裝失敗 (代碼 {0})：{1}", "✘ Install failed (code {0}): {1}"),
        ["RtUnsupportedFmt"] = ("✘ 此系統無法自動安裝，請手動下載：{0}", "✘ Auto install is not supported on this system. Download manually: {0}"),
        ["RtNoPackageManagerFmt"] = ("✘ 找不到套件管理員 {0}，請手動下載：{1}", "✘ Package manager {0} not found. Download manually: {1}"),
        ["RtErrorFmt"] = ("✘ 發生錯誤：{0}", "✘ Error: {0}"),
        ...
        ["ShowInvalidRowsOnly"] = ("只顯示錯誤列", "Show invalid rows only"),
